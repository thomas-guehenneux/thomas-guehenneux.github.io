...
**What's NNNNNNNNew in Android Security?** _by Scott Alexander-Bown_  
...
**Scaling Android @Facebook** _by Marco Cova & Balazs Balazs_  
...
**What's New in Android** _by Chet Haase_  
...
**Android Application Security, The Right Way** _by Dario Incalza_  
...
- _Android 7_: iOS level security (on the Google Pixel at least)
- _Android 6_: Almost iOS level, but you cant besure that encryption keys are protected in hardware. Also new API's for file encryption/device protected storage are not available.
- _Android 5_: First fingerprint authentication API and KeyStore API supporting user authentication.

**Radical RecyclerView** _by Lisa Wray_  
...
**Android Architecture Blueprints** _by David Gonzalez & Jose Alcerreca_  
